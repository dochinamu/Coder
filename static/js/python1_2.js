...
var quiz_list = {
    ...
    "pre_blank":`status = "Completing spreadsheet" <br/>`,'after_blank': `print(status)`, 'answer': ['status = "Writing code"', 'status= "Writing code"', 'status ="Writing code"', 'status="Writing code"', 'status = “Writing code”']},
