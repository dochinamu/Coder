...
var quiz_list = {
    ...
    'pre_blank': 'score = 51 <br/> pass_grade = score > 50 <br/> if', 'after_blank': ': <br/> &nbsp &nbsp &nbsp print(pass_grade)', 'answer': ['pass_grade'], 'output': 'True'},
    ...
    'pre_blank': `today = "Sunday" <br/> if`, 'after_blank': '<br/> &nbsp &nbsp &nbsp print("Ring the alarm at 7:00")', 'answer': ['today != "Saturday":', 'today!="Saturday":', 'today!= "Saturday":', 'today !="Saturday":', `today != “Saturday”:`, `today!= “Saturday”:`, `today !=“Saturday”:`, `today!=“Saturday”:`], 'output': 'Ring the alarm at 7:00'}, 
    10: {'type': 'typing', 'question1': '<span class = "highlight_text">age</span>가 18보다 큰지 비교해봅시다!', 'question2': '',
    'pre_blank': `can_drive = False <br/> age = 20 <br/> if`,  'after_blank': '<br/> &nbsp &nbsp &nbsp can_drive = True <br/> print(can_drive)', 'answer': ['age > 18:', 'age>18:', 'age >18:', 'age> 18:'], 'output': 'True'}, 
